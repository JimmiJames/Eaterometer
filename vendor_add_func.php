     ...
     if(isset($_POST['Confirm']))
     {
       ...
       // $sql2 = "INSERT INTO customer_login (`Email`,`Password`) VALUES ('$email','$password');";
        ...
        //   }
          ...
          $add_start_time = $_POST['starts'];
           $add_end_time = $_POST['end'];
           $allotted_item_name = $_POST['item'];
           $price = $_POST['price'];
           $vendor_id= "1";
        //   echo "$add_start_time";
        
        $sql = "INSERT INTO `slot_mgt` (slot_time_start,slot_time_end,allotted_item_name,price,vendor_id) VALUES ('$add_start_time','$add_end_time','$allotted_item_name','$price','$vendor_id')";
