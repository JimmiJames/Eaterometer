               ...
               <div class="container">
                  <div class="row">
                     ...
                     <div class="col-md-4">
                        ...
                        <hr>
                        <img src="images/img20.jpg" alt="" class="img-fluid">
                        <p></p>
                        <div class="panel">
                           <div class="panel-heading">
                              <h4 class="panel-title"><a data-parent="#accordion" data-toggle="collapse" class="panel-toggle collapsed" href="#faq1" aria-expanded="false"><i class="ti-info-alt" aria-hidden="true"></i>What is the name of the underwater restaurant in Dubai?

                             </a></h4>
                           </div>
                           <div class="panel-collapse collapse" id="faq1" aria-expanded="false" role="article" style="height: 0px;">
                              <div class="panel-body"> <strong>Ossiano Restaurant</strong> <br> 
The underwater restaurant Ossiano at Atlantis, The Palm hotel is one of the best-known restaurants in Dubai, United Arab Emirates. But unlike most of the city's most expensive restaurants, there's no minimum spend. </div>
                           </div>
                        </div>
                        <!-- end:panel -->
                        <div class="panel">
                           <div class="panel-heading">
                              <h4 class="panel-title"><a data-parent="#accordion" data-toggle="collapse" class="panel-toggle" href="#faq2" aria-expanded="true"><i class="ti-info-alt" aria-hidden="true"></i>How many restaurants are in Atlantis Dubai?</a></h4>
                           </div>
                           <div class="panel-collapse collapse" id="faq2" aria-expanded="true" role="article">
                              <div class="panel-body"> Indulge In The City's Premier Dining Destination. View Our Range Of Gourmet Experiences. The Best Place For Memorable Dining Experiences. Reserve Your Table Now. Award Winning. Brunches. Various Cuisines. Types: Celebrity Chefs, Signature Restaurants. </div>
                           </div>
                        </div>
                        <!-- end:Panel -->
